...
- [x] **Phase 3: Gallery & Products** - Full browsable product gallery with collection filtering, individual product pages, and international context (completed 2026-03-12)
...
Plans:
- [x] 03-01-PLAN.md — Schema madeToOrder field, product image migration, MTO examples, product.id standardization
- [x] 03-02-PLAN.md — GalleryGrid, FilterBar, StockBadge components + /shop page with filtering
- [x] 03-03-PLAN.md — Product detail pages (/shop/[slug]) with GLightbox, CommissionCTA, breadcrumbs
- [x] 03-04-PLAN.md — AboutMaker section, shipping note, nav link update + visual checkpoint
...
Plans:
- [x] 04-01-PLAN.md — Workshop /workshop page with Web3Forms form, hCaptcha, nav + link restoration
- [x] 04-02-PLAN.md — Hospitality section expansion with service bullets and email CTA
...
Plans:
- [x] 05-01-PLAN.md — Preloader removal, BaseLayout ogImage prop, LocalBusiness schema, Product JSON-LD, per-page OG images
- [x] 05-02-PLAN.md — Lighthouse mobile audit and data-driven performance fixes + visual checkpoint
...
| 3. Gallery & Products | 4/4 | Complete   | 2026-03-12 |
